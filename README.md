...
- [Builder](#builder)
  - [Options](#options)
    - [IPC plugin `Action` type](#ipc-plugin-action-type)
...
> [!WARNING]
> Since KiCad 9 there are two plugin mechanisms: IPC and Swig based (too learn more see [this](https://dev-docs.kicad.org/en/apis-and-binding/index.html)).
> The `hatch-kicad` by default packages plugins to old deprecated (Swig based) structure.
> This behaviour can be changed using `compatibility` option.
...
For `legacy` compatibility mode, depending on the project structure,
it may be required to [rewrite relative paths](https://hatch.pypa.io/latest/config/build/#rewriting-paths).
...
| ------------        | -------                                                                                    | --------------                                                                                                                                                                                                                                                                                                       | --------------------------------------------------------                                                                                                                                                                                                                                                                                       |
| `compatibility`     | `str`                                                                                      | `legacy`                                                                                                                                                                                                                                                                                                             | The plugin packaging mode. Can be equal `legacy` or `ipc`.                                                                                                                                                                                                                                                                                     |
...
| `actions`           | list of `Action`                                                                           | **required** when in `ipc` `compatibility` mode                                                                                                                                                                                                                                                                      | The list of plugin registered actions. For details refer to [IPC plugin `Action` type](#ipc-plugin-action-type) chapter.                                                                                                                                                                                                                       |
...
<!-- TOC --><a name="ipc-plugin-action-type"></a>
#### IPC plugin `Action` type

This type is new addition which is required when using `ipc` `compatibility` mode.
In `ipc` mode the `hatch-kicad` plugin creates PCM archive which includes `plugin.json`.
The `plugin.json` must comply to KiCad's [schema](https://gitlab.com/kicad/code/kicad/-/raw/master/api/schemas/api.v1.schema.json)
and is generated based on `actions` option which uses `Action` type
as described below:

| Option              | Type                                                                                       | Default                                                                                                                                                                                                                                                                                                              | Description                                                                                                                                                                                                                                                                                                                                    |
| ------------        | -------                                                                                    | --------------                                                                                                                                                                                                                                                                                                       | --------------------------------------------------------                                                                                                                                                                                                                                                                                       |
| `identifier`        | `str`                                                                                      | **required**                                                                                                                                                                                                                                                                                                         | An identifier for the action, must be unique within a plugin.                                                                                                                                                                                                                                                                                  |
| `name`              | `str`                                                                                      | **required**                                                                                                                                                                                                                                                                                                         | A human-readable name for the action (normally a verb or verb phrase).                                                                                                                                                                                                                                                                         |
| `description`       | `str`                                                                                      | **required**                                                                                                                                                                                                                                                                                                         | A human-readable description for the action.                                                                                                                                                                                                                                                                                                   |
| `show_button`       | `bool`                                                                                     | `True`                                                                                                                                                                                                                                                                                                               | Whether or not to show the action in the toolbar. When enabled then `icons-light` list must have at least one icon defined.                                                                                                                                                                                                                    |
